// src/services/health/outdoor/outdoorIOS.service.ts
...
export type OutdoorIOSReadSessionsInput = HealthImportedOutdoorQuery & {
    includeRoutes?: boolean;
};

export type OutdoorIOSPermissionsRequest = {
...
export async function isOutdoorIOSAvailable(): Promise<boolean> {
    return healthIOSBridge.isAvailable();
}

export async function getOutdoorIOSPermissionsStatus(
    input: OutdoorIOSPermissionsRequest
...
export async function requestOutdoorIOSPermissions(
    input: OutdoorIOSPermissionsRequest
): Promise<HealthPermissionsStatus> {
    return healthIOSBridge.requestPermissions(input);
}

export async function readOutdoorIOSSessions(
    input: OutdoorIOSReadSessionsInput
