// /src/services/health/cardio/cardioSessionMedia.service.ts

/**
 * Cardio session media service.
...
export type UploadCardioSessionMediaArgs = {
    date: string;
    sessionId: string;
    files: RNFile[];
...
export type UploadCardioSessionMediaResult = {
    uploadedCount: number;
};

export type DeleteCardioSessionMediaArgs = {
    date: string;
    sessionId: string;
    publicId: string;
    returnMode?: SessionMediaReturnMode;
...
export type DeleteCardioSessionMediaResult = {
    deleted: boolean;
};

export type AttachCardioSessionMediaArgs = {
    date: string;
    sessionId: string;
...
export type AttachCardioSessionMediaResult = {
...
export async function uploadCardioSessionMedia(
    args: UploadCardioSessionMediaArgs
): Promise<UploadCardioSessionMediaResult> {
...
export async function deleteCardioSessionMedia(
    args: DeleteCardioSessionMediaArgs
): Promise<DeleteCardioSessionMediaResult> {
...
export async function attachCardioSessionMedia(
    args: AttachCardioSessionMediaArgs
): Promise<AttachCardioSessionMediaResult> {
