// src/features/health/cardio/components/CardioRoutePreview.tsx
...
export function CardioRoutePreview({ hasRoute, routeSummary }: Props) {
...
export default CardioRoutePreview;
