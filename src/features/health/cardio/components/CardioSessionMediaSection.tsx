// /src/features/health/cardio/components/CardioSessionMediaSection.tsx
...
import { useCardioSessionMedia } from "@/src/hooks/health/cardio/useCardioSessionMedia";
import { useTheme } from "@/src/theme/ThemeProvider";
import type { WorkoutSession } from "@/src/types/workoutDay.types";

import CardioSessionMediaCard from "./CardioSessionMediaCard";
import CardioSessionMediaPickerButton from "./CardioSessionMediaPickerButton";
...
export default function CardioSessionMediaSection({
    date,
    session,
    onRefresh,
}: Props) {
    ...
    const mediaHook = useCardioSessionMedia({
        date,
        ...
        >
            ...
            >
                <View style={{ flex: 1 }}>
                    ...
                    >
                        Sube imágenes o videos relacionados con esta sesión cardio.
                    </Text>
                </View>

                <CardioSessionMediaPickerButton
