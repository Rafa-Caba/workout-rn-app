// /src/features/health/cardio/components/CardioSessionMediaCard.tsx
...
export default function CardioSessionMediaCard({
    item,
    onPress,
    onDelete = null,
    deleting = false,
    ...
    const subtitle = formatCardioMediaDateTime(item.createdAt);
